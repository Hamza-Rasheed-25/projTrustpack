...
export default function Edit_PO() {
    ...
    const { data, setData, put, processing, errors} = useForm<Required<CreateUserForm>>({
        ...
        number_of_reels: rr.number_of_reels || '',
        reel_design_1: rr.reel_design_1 || 'empty',
        reel_design_2: rr.reel_design_2 || 'empty',
        reel_design_3: rr.reel_design_3 || 'empty',
        reel_design_4: rr.reel_design_4 || 'empty',
        reel_design_5: rr.reel_design_5 || 'empty',
        reel_design_6: rr.reel_design_6 || 'empty',
        reel_design_7: rr.reel_design_7 || 'empty',
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('rr.update', rr.id));
    };
                ...
                <div className="w-full max-w-sm">
                    <div className="flex flex-col">
                        <div className="flex h-full flex-1 flex-col gap-2 rounded-xl">
                            <div>
                                <h1 className="text-center text-xl font-medium">Edit the RR</h1>
                            </div>
